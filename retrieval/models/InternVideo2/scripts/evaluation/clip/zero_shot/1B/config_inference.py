...
model = dict(
    ...
    text_encoder=dict(
        ...
        llama_path="/c1/kangsan/checkpoints/chinese_alpaca_lora_7b",
        use_lora=True,
    ),
    temp=1 / 100.0,
    temp_min=1 / 100.0,
    ...
    tokenizer_path="/c1/kangsan/checkpoints/chinese_alpaca_lora_7b",
    vision_ckpt_path="/c1/kangsan/checkpoints/InternVideo2-Stage2_1B-224p-f4/InternVideo2-stage2_1b-224p-f4.pt",
    load_vision_ckpt_from_internvideo2_stage2=True,
    text_ckpt_path="/c1/kangsan/checkpoints/internvl_c_13b_224px.pth",
)
...
save_iter = 500
auto_resume = True
pretrained_path = "/c1/kangsan/checkpoints/InternVideo2-CLIP-1B-224p-f8/1B_clip.pth"  # path to pretrained model weights, for resume only?
